...
def clean_text(raw_text):
    """
    Simple text-cleaning function. Deletes unncessary whitespace and writes output to Cleaned_Texts folder.

    :param input_path: Path to the input file (assumed to be ascii or UTF-8)
    :return:
    """
